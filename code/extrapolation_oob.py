"""Part 2 full — 50 Heston seeds, in-box base vs out-of-box xi=0.7 / xi=1.2.
Density sanity + folded-normal (ratio/gaussian/skew/kurt) + Lewis ground-truth extrapolation bias brel.
"""
...
LEW={k:lewis_pdf(dict(pr,T=1.0),yg) for k,pr in CFG.items()}   # analytical ground truth (any box)
